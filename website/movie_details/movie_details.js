// Import the `changeServer` function
import { changeServer } from './change_server.js';
...
// Add the `changeServer` function to the `displayMovieDetails` function
displayMovieDetails();

// Add the `changeServer` function to the `fetchVideoDetails` function
